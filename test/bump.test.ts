        ...
        "phases": {
          ...
          "build": {
            "commands": [
              ...
              "$SKIP || { git merge-base --is-ancestor bump/$VERSION origin/master && { echo \"Skipping: bump/$VERSION is an ancestor of origin/master\"; export SKIP=true } ; }",
              "$SKIP || { git remote add origin_ssh git@github.com:owner/repo.git ; }",
              "$SKIP || { git push --follow-tags origin_ssh bump/$VERSION:bump/$VERSION ; }",
