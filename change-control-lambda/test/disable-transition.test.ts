...
describe('disableTransition', () => {
  const disableTransition = require('../lib/disable-transition').disableTransition;
...
test('enableTransition', async () => {
  // GIVEN
  const enableTransition = require('../lib/disable-transition').enableTransition;
  // WHEN
